	...
	<body>
		...
		<div class="footer" role="contentinfo">
            ...
            <ul>
                ...
                <br/>
                <li><g:link controller="link" action="index">Links</g:link></li><span style="color: #fff;">&nbsp;|&nbsp;</span>
                <li><g:link controller="link" action="stories">Stories</g:link></li><span style="color: #fff;">&nbsp;|&nbsp;</span>
                <li><g:link controller="photo" action="photos">Photos</g:link></li>
