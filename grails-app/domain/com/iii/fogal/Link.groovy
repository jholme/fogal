...
class Link {
	...
	static public final String SHOWS = "Shows"
	...
	static public final List<String> linkCats = [BOOKS,NEWS,SHOWS,ORGS,PUBS,PHO,OTH]
	static public final List<String> allCats = [BOOKS,NEWS,SHOWS,ORGS,PUBS,PHO,OTH,PHOS,STOS]
